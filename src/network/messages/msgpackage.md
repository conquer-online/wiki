...
| Pos | Type | Name | Description | Example |
|:-------|:--------|:--------|:--------|:--------|
| 0  | UInt32 | [Item ID](../identifiers.md) | Unique identifier of the item | 1 |
...
|:----|:--------|:--------|:--------|:--------|:--------|
| 0 | QUERY_LIST | Query for a list of items | Server | [NPC ID](../identifiers.md) | [PackageItem](#package-item-definition)[] |
| 1 | CHECK_IN | Deposit an item | Server | [NPC ID](../identifiers.md) | ItemID |
| 2 | CHECK_OUT | Withdraw an item | Server | [NPC ID](../identifiers.md) | ItemID |
