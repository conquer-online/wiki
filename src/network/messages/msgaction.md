...
| 147 | XP_CLEAR | Notify clear XP | Server | [Hero ID](/network/identifiers.md) |  |
...
| 105 | QUERY_MEMBER | Get team member info | Server | [Hero ID](/network/identifiers.md) | [Target ID](/network/identifiers.md) |
