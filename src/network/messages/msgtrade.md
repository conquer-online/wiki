...
| 4 | UInt32 | Data | Data or a [unique Identifier](../identifiers.md) | 10 |
...
|:------|:--------|:--------|:--------|:--------|
| 1  | APPLY | Request trade | Both | Requester's [Hero ID](../identifiers.md) |
| 2  | QUIT | Request cancel | Server | |
| 3  | OPEN | Open trade window | Client | Target's [Hero ID](../identifiers.md) |
| 4  | SUCCESS | Successful trade | Client | |
| 5  | FALSE | Failed trade | Client | |
| 6  | ADDITEM | Add item to trade window | Server | [Item ID](../identifiers.md) |
...
| 11 | ADDITEM_FALSE | Cannot add item for trade | Client | [Item ID](../identifiers.md) |
