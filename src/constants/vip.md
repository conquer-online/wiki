...
🟠 Sourced from Client 5517 [CN_Res.ini](../files/content/cn_res.ini.md). If not marked with an asterisk, then it is sourced from [Archived Documentation](https://web.archive.org/web/20170703175033/http://vips.99.com/CO/rank.html) 
